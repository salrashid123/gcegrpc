const {EchoRequest} = require('./www/echo/echo_pb.js');
const {EchoServerClient} = require('./www/echo/echo_grpc_web_pb.js');

const grpc = {};
grpc.web = require('grpc-web');

var echoService = new EchoServerClient('https://grpcweb.domain.com', null, null);
